...
namespace TexasHoldemOdds
{
    ...
    public class HoldemHand
    {
        ...
        public Tuple<double, double, double> GetOddsOfWinningDrawingAndLosing(SharedCards shared)
        {
            Deck deck = new Deck();
            ...
            return new Tuple<double, double, double>(potentialWins / possibleHands.Count, potentialDraws / possibleHands.Count, potentialLosses / possibleHands.Count);
        }
